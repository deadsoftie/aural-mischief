...
Project1Component::Project1Component()
{
...
void Project1Component::paint(juce::Graphics& g)
{
	g.fillAll(juce::Colours::darkslategrey);
}

void Project1Component::resized()
{
...
void Project1Component::buildChooseTable(int maxDegree)
{
...
void Project1Component::setDegree(int d)
{
